...
def main():
    ...
    print("""
  ######################################
  # SEZ Development Environment Setup #
  ######################################

  This script will create your SEZ dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your SEZ project folder:
    [Arma 3 installation directory]\\{} => SEZ project folder
    P:\\{}                              => SEZ project folder
